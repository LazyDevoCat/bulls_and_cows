...
from cows import check_player_input, counting_cows_and_bulls, generate_num


class TestInput(unittest.TestCase):

    def test_valid_input(self):
        assert check_player_input("1234") == "1234"

    def test_non_numeric_input(self):
        assert check_player_input("abcd") == "Write a number"

    def test_too_short_input(self):
        assert check_player_input("123") == "Write 4-digits"

    def test_too_long_input(self):
        assert check_player_input("12345") == "Write 4-digits"

    def test_duplicate_digits(self):
        assert check_player_input("1123") == "Write number without the same nums!"

    def test_edge_case_all_same(self):
        assert check_player_input("1111") == "Write number without the same nums!"
